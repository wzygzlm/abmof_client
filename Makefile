...
SRC_EFAST_TCP = efast_client_TCP.cpp motion_field.cpp
SRC_EFAST_UDP = efast_client_UDP.cpp motion_field.cpp
...
ALL: $(PROG_ABMOF_TCP) $(PROG_ABMOF_UDP) $(PROG_EFAST_TCP) $(PROG_EFAST_UDP) $(PROG_HARRIS_DEMO)
...
$(PROG_EFAST_TCP):$(SRC_EFAST_TCP)
		$(CC) $(CFLAGS) -o $(PROG_EFAST_TCP) $(SRC_EFAST_TCP) $(LIBS)

$(PROG_EFAST_UDP):$(SRC_EFAST_UDP)
		$(CC) $(CFLAGS) -o $(PROG_EFAST_UDP) $(SRC_EFAST_UDP) $(LIBS)

$(PROG_HARRIS_DEMO):$(SRC_HARRIS_DEMO)
		$(CC) $(CFLAGS) -o $(PROG_HARRIS_DEMO) $(SRC_HARRIS_DEMO) $(LIBS)

clean:
	rm -rf $(PROG_ABMOF_TCP) $(PROG_ABMOF_UDP) $(PROG_EFAST_TCP) $(PROG_EFAST_UDP) $(PROG_HARRIS_DEMO) *.o *.dSYM
	echo Clean done
